...
This project was a collaboration with [Triton Growth (Formerly Lions Digital Solution)](https://www.tritongrowth.com/).
...
## A video of the dashboard (ASIN by ASIN page)

<video className="w-ful" controls>
  <source
    src="/static/images/_markdowns/projects/clearsight/asin-by-asin.mp4"
    type="video/mp4"
  />
</video>
