...
export default function P404() {
  return (
    <div css={tw`h-screen w-screen bg-gray-100 flex items-center`}>
      <div
        css={tw`container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700`}
      >
        <div css={tw`max-w-md`}>
          <div css={tw`text-5xl`}>404</div>
          <p css={tw`text-2xl md:text-3xl font-light leading-normal`}>
          ...
          <button
            css={tw`px-4 inline py-2 text-sm font-medium leading-5 shadow text-white transition-colors duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-blue bg-blue-600 active:bg-blue-600 hover:bg-blue-700`}
          >
            back to homepage
          </button>
        </div>
