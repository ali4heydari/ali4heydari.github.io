              ...
              <div className="space-y-2 py-6">
                {navigation.primary.map((item) => (
                  <Link
                    key={item.name}
                    href={item.href}
                    className="-mx-3 block  rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50 dark:bg-gray-800 dark:text-gray-100 dark:hover:bg-gray-700 dark:hover:bg-gray-800"
                  >
                    {item.name}
                  </Link>
                ))}
