...
const BottomNavigation = () => {
  ...
  return (
    <div className="sticky bottom-0 left-0 z-50 w-full h-16 border-t border-gray-200 bg-gray-100 dark:bg-gray-800 dark:shadow-indigo-400 dark:border-gray-600 lg:hidden">
